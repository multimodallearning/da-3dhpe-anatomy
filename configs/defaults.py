...
_C.INPUT.NUM_POINTS_TARGET = 2048
_C.INPUT.NUM_POINTS_TEST = 2048
_C.INPUT.ROT_DEGREE = 0.
_C.INPUT.ROT_DEGREE_TARGET = 0.
_C.INPUT.TRANSLATION = 0.
_C.INPUT.TRANSLATION_TARGET = 0.
...
_C.DA.MEAN_TEACHER = CN()
_C.DA.MEAN_TEACHER.INPUT_NUM_POINTS = 2048
_C.DA.MEAN_TEACHER.INPUT_TRANSLATION = 0.1
_C.DA.MEAN_TEACHER.INPUT_ROTATION = 10.
_C.DA.MEAN_TEACHER.ALPHA = 0.99
_C.DA.MEAN_TEACHER.RAMPUP_LENGTH = 40
_C.DA.MEAN_TEACHER.CONS_LOSS_FAC = 1.
